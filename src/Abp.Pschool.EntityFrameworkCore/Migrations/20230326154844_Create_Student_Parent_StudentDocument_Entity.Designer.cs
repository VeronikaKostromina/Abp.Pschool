...
namespace Abp.Pschool.Migrations
{
    ...
    [Migration("20230326154844_Create_Student_Parent_StudentDocument_Entity")]
    partial class CreateStudentParentStudentDocumentEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Pschool.Parents.Parent", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppParents", (string)null);
                });

            modelBuilder.Entity("Abp.Pschool.StudentDocuments.StudentDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Pschool.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("StudentMarkType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Pschool.StudentDocuments.StudentDocument", b =>
                {
                    b.HasOne("Abp.Pschool.Students.Student", "Student")
                        .WithOne("StudentDocument")
                        .HasForeignKey("Abp.Pschool.StudentDocuments.StudentDocument", "StudentId")
            ...
            modelBuilder.Entity("Abp.Pschool.Students.Student", b =>
                {
                    b.HasOne("Abp.Pschool.Parents.Parent", "Parent")
                        .WithMany("Students")
